from natureast import AST_TYPE
from copy import deepcopy
from sys import exit
from naturebuiltins import builtins, Array, Dict
...
def evaluate(ast, scope=initial):
    ...
    if (
        ...
        if expr:
            ...
            if len(ops) > 1 and (opOrder[ops[1]] > opOrder[ops[0]]):
                right = n.pop()
                left = n.pop()
                op = ops.pop()
